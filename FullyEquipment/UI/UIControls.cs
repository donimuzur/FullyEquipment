...
namespace FullyEquipment.UI
{
    ...
    public static class Extensions
    {
        ...
        public static Il2CppSystem.Object HexToColor(this Il2CppSystem.String hexString)
        {
            ...
            r = System.Convert.ToByte(tmp.Substring(0, 2), 16);
            g = System.Convert.ToByte(tmp.Substring(2, 2), 16);
            b = System.Convert.ToByte(tmp.Substring(4, 2), 16);
            if (tmp.Length == 8)
